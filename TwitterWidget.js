...
$(".twitter-feed").each(function(index){
	...
	var $input = $( this );
	$(this).prepend('<a class="twitter-timeline" href="' + mw.html.escape($input.attr('href')) + '" data-widget-id="' + mw.html.escape($input.attr('data-widget-id')) + '" width="700" height="1250">Tweets from ' + mw.html.escape($input.attr('source')) + '</a>');
});
